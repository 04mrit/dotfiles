...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    --app sourtcut
    , ((controlMask, xK_1), spawn "exec /bin/librewolf")
    , ((controlMask, xK_2), spawn "exec /bin/codium")
    , ((controlMask, xK_3), spawn "exec /bin/nautilus")
    , ((modm .|. shiftMask, xK_r), spawn "exec /bin/reboot") 
...
myStartupHook = do
  ...
  --spawnOnce "feh --bg-fill /home/amrit/wallpapers/alex-conchillos.jpg"
  spawn "bash ~/git/scripts/ad.sh"
  spawnOnce "feh --bg-fill /home/amrit/wallpapers/exp/special.jpg"
  spawnOnce "betterlockscreen -u /home/amrit/wallpapers/exp/special.jpg"
  spawnOnce "picom --experimental-backends"
  spawnOnce "greenclip daemon"
  spawnOnce "dunst"
  spawnOnce "exec firefox"
